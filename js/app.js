...
const BABY_BOND_RATE = 0.074;          // Babakötvény 2026: infláció + 3%
    ...
    funnel: {
      ...
      calc: {
        ...
        compute(v) {
          ...
          const START = 42500; // eletkezdesi tamogatas szuletesnel
          const pct = v.support === "gyvk" ? 0.2 : 0.1;
          const capSupport = v.support === "gyvk" ? 24000 : 12000;
          const yearly = v.monthly * 12;
          /* A tamogatas a BEFIZETES aranyaban jar, felso korlattal — korabban
             itt fix 12 000 Ft szerepelt, ami kis befizetesnel tulbecsult. */
